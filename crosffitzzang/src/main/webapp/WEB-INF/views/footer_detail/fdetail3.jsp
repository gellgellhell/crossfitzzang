...
<body>
	<div class="container">
			<%@ include file="../home_header.jsp" %>
				<br>
				<h1 class="mb-3 font-weight-bold text-center text-muted">위치정보 이용약관</h1>
				<hr>
				<br>
	...
	<div class="container border border-muted rounded mt-2 ml-1"
			style="width: 100%; height: 400px; overflow: auto">
				...
				이 약관은 미치다 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
				...
				회사는 다음과 같이 위치정보 관리책임자를 지정하여 이용자들이 서비스 이용과정에서 발생한 민원사항 처리를 비롯하여 개인위치정보주체의 권리 보호를 위해 힘쓰고 있습니다.[출처] 네이버 위치정보 이용약관|작성자 고상한 그녀
