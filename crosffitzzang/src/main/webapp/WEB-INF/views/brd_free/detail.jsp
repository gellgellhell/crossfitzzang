...
<body>
	...
	$(document).ready(function() {
		$.get(
			"${pageContext.request.contextPath}/brdfree/detail/${bno}"
			, {}
		...
		$(".fa-heart, .fa-heartbeat").click(function() {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/brdfree/${bno}/"+whoClick
				, type : "put"
	...
	$(document).ready(function() {
		$("#btn_delete").click(function() {
			...
			$.ajax({
				...
				, url : "${pageContext.request.contextPath}/brdfree"
				, data : JSON.stringify({
							bno : $("#bno").val()
							, pwd : $("#pwd").val()
				})
...
location.assign(
	"${pageContext.request.contextPath}/free/uform?bno="
		+ $("#bno").val()
);//assign
		});//click
