...
<li class="page-item">
	<a class="page-link"
		href="${root}/board/list_search?reqPage=${beginPage-1}${search_uri1}${search_uri2}">
		Before
	</a>
</li>
</c:if>
...
<li class="page-item">
	<a class="page-link"
		href="${root}/board/list_search?reqPage=${page_num}${search_uri1}${search_uri2}">
		${page_num}
	</a>
</li>
</c:forEach>
...
<li class="page-item">
	<a class="page-link"
		href="${root}/board/list_search?reqPage=${endPage+1}${search_uri1}${search_uri2}">
		Next
	</a>
</li>
</c:if>
